...
import 'package:imburse_me/provider.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(
      home: new Scaffold(
        appBar: new AppBar(
          title: new Text('Scan the Invoice'),
        ),
        body: _buildBody(),
      ...
      child: Column(
        children: <Widget>[
          ...
          MaterialButton(
            ...
            onPressed: (){
              if(detectedInvoice != ""){
                  FirebaseProvider.addInvoice(detectedInvoice);
              }
            },
          )
        ],
      ...
      child: Container(
        child: ListView.builder(
            ...
            itemBuilder: (context, i) {
              ...
              detectedInvoice = " " + detectedInvoice;
